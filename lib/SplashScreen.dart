...
class SplsahScreen extends StatefulWidget {
  @override
  _SplsahScreenState createState() => _SplsahScreenState();
}

class _SplsahScreenState extends State<SplsahScreen> {
  String str1 = 'Active';
                ...
                child: SizedBox(
                  ...
                  child: Center(
                    child: ListTile(
                      ...
                      leading: Image.network(
                          'https://1000logos.net/wp-content/uploads/2019/07/Domino%E2%80%99s-logo-1996%E2%80%932012.jpg'),
                      onTap: () {
                        showDialog<Null>(
                            context: context,
                            barrierDismissible: false,
